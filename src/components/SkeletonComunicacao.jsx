 ...
 * Simula o header, a tab bar e o conteúdo da aba ativa.
 */
export default function SkeletonComunicacao() {
  return (
    <div className="space-y-6 max-w-[1060px] mx-auto w-full" aria-label="Carregando comunicação">
      {/* Page header */}
      ...
      <div className="flex gap-1 border-b border-line pb-0">
        {Array.from({ length: 4 }, (_, i) => (
          <div
            key={i}
            className="flex items-center gap-1.5 px-4 py-2.5 border-b-2 -mb-[1px]"
          >

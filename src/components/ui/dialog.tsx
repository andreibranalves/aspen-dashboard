...
const overlayClass =
  'fixed inset-0 z-50 bg-black/60 backdrop-blur-xs motion-safe:data-[state=open]:animate-in motion-safe:data-[state=open]:fade-in-0';
    ...
    <RadixDialog.Root open={open} onOpenChange={onOpenChange}>
      <RadixDialog.Portal>
        ...
        <RadixDialog.Content
          ...
          className={cn(
            'fixed left-1/2 top-1/2 z-50 flex max-h-[calc(100dvh-2rem)] w-[calc(100vw-2rem)] -translate-x-1/2 -translate-y-1/2 flex-col overflow-hidden rounded-card border border-line bg-surface text-fg shadow-overlay',
    ...
    <RadixDialog.Root open={open} onOpenChange={onOpenChange}>
      <RadixDialog.Portal>
        ...
        <RadixDialog.Content
          ...
          {...(description ? {} : { 'aria-describedby': undefined })}
          className={cn(
            'fixed inset-y-3 right-3 z-50 flex w-[calc(100vw-1.5rem)] flex-col overflow-hidden rounded-card border border-line bg-surface text-fg shadow-overlay lg:max-w-xl',

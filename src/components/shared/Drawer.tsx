...
/**
 * Drawer — painel lateral reutilizável para drill-down de registros.
 * Foco preso no painel, Escape fecha e o foco volta ao controle que abriu.
 */
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end">
      ...
      <div
        ...
        className={cn(
          'relative z-10 flex h-full flex-col bg-surface shadow-level-5',
          'w-full lg:max-w-xl',
          className
        )}
      >
        ...
        {actions && <div className="shrink-0 border-b border-line px-5 py-3">{actions}</div>}

          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-border">
                <th className="text-left py-2 px-1 font-medium text-muted-foreground text-xs uppercase tracking-wider">SKU</th>
                <th className="text-left py-2 px-1 font-medium text-muted-foreground text-xs uppercase tracking-wider">Produto</th>
                <th className="text-right py-2 px-1 font-medium text-muted-foreground text-xs uppercase tracking-wider">Qtd</th>
                <th className="text-right py-2 px-1 font-medium text-muted-foreground text-xs uppercase tracking-wider">Un</th>
                <th className="text-right py-2 px-1 font-medium text-muted-foreground text-xs uppercase tracking-wider">Preço un.</th>
                <th className="text-right py-2 px-1 font-medium text-muted-foreground text-xs uppercase tracking-wider">Total</th>
              </tr>
            </thead>
            <tbody>
              {items.map((item, idx) => (
                <tr key={idx} className="border-b border-border/50 last:border-0">
                  ...
                  <td className="py-2 px-1 text-right text-muted-foreground">{item.uom || 'und'}</td>

...
- Exigem autorização explícita e separada: push direto em `master`, deploy manual, alteração de env operacional, envio externo, efeitos sobre dados ou comunicação reais e aplicar migration em qualquer alvo que não seja PostgreSQL local descartável.

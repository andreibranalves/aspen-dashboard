...
test('routes: não registra endpoints aposentados', () => {
  ...
  assert.equal(Object.prototype.hasOwnProperty.call(routes, 'atendimento-contact'), true);
  ...
  assert.equal(Object.prototype.hasOwnProperty.call(routes, 'send-whatsapp'), false);
});

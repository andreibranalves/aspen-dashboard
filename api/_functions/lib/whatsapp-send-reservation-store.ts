...
export const WHATSAPP_SEND_RESERVATION_RESERVED_TTL_SECONDS = 15 * 60;
export const WHATSAPP_SEND_RESERVATION_RETRY_TTL_SECONDS = 15 * 60;
export const WHATSAPP_SEND_RESERVATION_COMPLETED_TTL_SECONDS = 7 * 24 * 60 * 60;

...
import { evolutionRequest, unwrapEvolutionCollection } from './evolution-history.js';
...
export { normalizeWhatsappConversationInput, normalizeWhatsappMessageInput, evolutionRequest, unwrapEvolutionCollection };
